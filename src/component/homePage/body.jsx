...
function Body() {
  return (
    ...
    <div className="flex text-6xl font-thin w-full bg-green-500 justify-center">
      Endless Collections of Books
    </div>
      <div className="text-md font-light w-full bg-red-500 justify-center px-64 xl:px-[24rem] py-16">
